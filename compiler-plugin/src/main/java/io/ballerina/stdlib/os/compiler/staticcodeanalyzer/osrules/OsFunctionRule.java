...
/**
 * Interface to be implemented by all OS function analysis rules.
 */
public interface OsFunctionRule {

    /**
     * Analyze the given OS function call and report issues if any.
     *
     * @param context Context information required to analyze the function call
     */
    void analyze(OsFunctionContext context);
     ...
     */
    boolean isApplicable(OsFunctionContext context);
}
